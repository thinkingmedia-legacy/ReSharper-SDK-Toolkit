...
namespace ReSharperToolKit.Modules.Services.Impl
{
    ...
    public class ProjectService : iProjectService
    {
        ...
        /// </summary>
        public IProjectFile getFileOrCreate([NotNull] IProject pProject, [NotNull] string pNameSpace,
        ...
        /// </summary>
        public IProjectFolder getFolder([NotNull] IProject pProject, [NotNull] string pNameSpace)
        {
            if (pProject == null)
            {
                throw new ArgumentNullException("pProject");
        ...
        /// </summary>
        public T getFileAs<T>([NotNull] IProjectFile pFile) where T : class, IFile
        {
            if (pFile == null)
            {
